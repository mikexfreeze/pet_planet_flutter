...
/// The [Posts] holds items in memory, provides a synchronous access
...
class Posts extends ChangeNotifier {
  ...
  Post getByIndex(int index) {
    ...
    if (_pages.containsKey(startingIndex)) {
      var item = _pages[startingIndex].post[index - startingIndex];
      return item;
    }

    // We don't have the data yet. Start fetching it.
    _fetchPage(startingIndex, index);
